...
import com.farhad.example.myjhipsterplanet.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().customerName(DEFAULT_CUSTOMER_NAME);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().customerName(UPDATED_CUSTOMER_NAME);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.customerName(UPDATED_CUSTOMER_NAME);
